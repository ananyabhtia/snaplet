const ButtonBox = ({ handleSave, handlePrev, handleNext }) => {
    return (
        <div className="flex flex-row w-full h-1/12 border-yellow-700 rounded-xl justify-between items-center mb-1 px-2">
            <div className="flex flex-row border-orange-700 rounded-xl justify-between items-center gap-1 flex-wrap">
                <div onClick={handlePrev} className="flex flex-row bg-purple-300 hover:bg-purple-500 active:bg-purple-800 font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full h-full items-center text-xs sm:text-sm">
                ...
                <div className="flex flex-row bg-purple-300 hover:bg-purple-500 font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full h-full items-center text-xs sm:text-sm">
                    <p>line number</p>
                    <input type="text" className="bg-white ml-1 sm:ml-2 text-black rounded-full pl-1 sm:pl-2 w-6 sm:w-10 text-xs sm:text-sm"></input>
                </div>
                <div className="flex flex-row bg-purple-300 hover:bg-purple-500 font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full h-full items-center text-xs sm:text-sm">
                    <p>step number</p>
                    <input type="text" className="bg-white ml-1 sm:ml-2 text-black rounded-full pl-1 sm:pl-2 w-6 sm:w-10 text-xs sm:text-sm"></input>
