...
const ButtonBox = ({ handleSave, handlePrev, handleNext, handleAdd, handlePDF, currentStep, totalSteps, diagramTitle, setDiagramTitle }) => {
    ...
    return (
        <div className="flex flex-row w-full h-1/12 border-yellow-700 rounded-xl justify-between items-center mb-1 px-2 bg-white">
            ...
            <div className="flex flex-row border-orange-700 rounded-xl justify-between items-center gap-1">
                ...
                <div onClick={handlePDF} className="exclude-from-pdf flex flex-row items-center justify-center bg-yellow-200 hover:bg-yellow-400 font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full h-full cursor-pointer text-xs sm:text-sm active:bg-yellow-700">
