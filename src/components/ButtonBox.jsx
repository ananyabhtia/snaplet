const ButtonBox = () => {
    return (
        <div className="flex flex-row w-full h-1/12 border-2 border-yellow-700 rounded-xl justify-between items-center">
            <div className="flex flex-row border-2 border-orange-700 rounded-xl justify-between items-center">
                <button className="bg-gray-200 hover:bg-gray-400 font-bold py-2 px-4 rounded-full border-2 h-full m-1">prev</button>
            ...
            <div className="flex flex-row border-2 border-orange-700 rounded-xl justify-between items-center">
                ...
                <button className="bg-gray-200 hover:bg-gray-400 font-bold py-2 px-4 rounded-full border-2 h-full m-1">save</button>
            </div>
        </div>
    );
};
