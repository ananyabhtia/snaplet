    ...
    return (
        <div className="border-red-700 flex flex-row rounded-xl mb-2 h-1/16 items-center">
            <div className="flex flex-row w-1/6 h-full rounded-xl mr-2 items-center justify-center">
                <h1 className="text-transparent text-3xl font-extrabold bg-clip-text bg-gradient-to-r from-orange-500 via-red-500 to-yellow-400 drop-shadow-lg">Program Tracer</h1>
            </div>
